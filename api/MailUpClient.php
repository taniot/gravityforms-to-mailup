...
class MailUpClient {
    ...
    function loadToken() {
        ...
        $this->accessToken = get_option('mailup_access_token');
        $this->refreshToken = get_option('mailup_refresh_token');
    }

    function saveToken() {

        update_option('mailup_access_token', $this->accessToken);
        update_option('mailup_refresh_token', $this->refreshToken);
    }
